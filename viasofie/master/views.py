...
class Disclaimer(View):
    def get(self, request):
        context = LoadFooter.get_context(LoadFooter)
        if get_language() == 'fr':
            context['disclaimer_body'] = DynamicPageContent_FR.objects.filter(identifier__iexact="disclaimer_body")
        elif get_language() == 'en':
            context['disclaimer_body'] = DynamicPageContent_EN.objects.filter(identifier__icontains="disclaimer_body")
        else:
            context['disclaimer_body'] = DynamicPageContent.objects.filter(identifier__icontains="disclaimer_body")
...
class PrivacyBeleid(View):
    def get(self, request):
        context = LoadFooter.get_context(LoadFooter)
        if get_language() == 'fr':
            context['privacy_beleid_body'] = DynamicPageContent_FR.objects.filter(identifier__iexact="privacy_beleid_body")
            context['privacy_beleid_sub'] = DynamicPageContent_FR.objects.filter(identifier__iexact="privacy_beleid_sub")
            context['bedrijfsnaam'] = DynamicPageContent_FR.objects.filter(identifier__icontains="bedrijfsnaam")
            context['bedrijfsadres'] = DynamicPageContent_FR.objects.filter(identifier__icontains="bedrijfsadres")
            context['bedrijfsemail'] = DynamicPageContent_FR.objects.filter(identifier__icontains="bedrijfsemail")
            context['bedrijfstelefoon'] = DynamicPageContent_FR.objects.filter(identifier__icontains="bedrijfstelefoon")
        elif get_language() == 'en':
            context['privacy_beleid_body'] = DynamicPageContent_EN.objects.filter(identifier__icontains="privacy_beleid_body")
            context['privacy_beleid_sub'] = DynamicPageContent_EN.objects.filter(identifier__icontains="privacy_beleid_sub")
            context['bedrijfsnaam'] = DynamicPageContent_EN.objects.filter(identifier__icontains="bedrijfsnaam")
            context['bedrijfsadres'] = DynamicPageContent_EN.objects.filter(identifier__icontains="bedrijfsadres")
            context['bedrijfsemail'] = DynamicPageContent_EN.objects.filter(identifier__icontains="bedrijfsemail")
            context['bedrijfstelefoon'] = DynamicPageContent_EN.objects.filter(identifier__icontains="bedrijfstelefoon")
        else:
            context['privacy_beleid_body'] = DynamicPageContent.objects.filter(identifier__icontains="privacy_beleid_body")
            context['privacy_beleid_sub'] = DynamicPageContent.objects.filter(identifier__icontains="privacy_beleid_sub")
            context['bedrijfsnaam'] = DynamicPageContent.objects.filter(identifier__icontains="bedrijfsnaam")
            context['bedrijfsadres'] = DynamicPageContent.objects.filter(identifier__icontains="bedrijfsadres")
            context['bedrijfsemail'] = DynamicPageContent.objects.filter(identifier__icontains="bedrijfsemail")
            context['bedrijfstelefoon'] = DynamicPageContent.objects.filter(identifier__icontains="bedrijfstelefoon")
...
class AdviceView(View):
    ...
    def get(self, request):
        context = LoadFooter.get_context(LoadFooter)
        if get_language() == 'fr':
            context['faq_begrippen'] = DynamicPageContent_FR.objects.filter(identifier__icontains="begrippen")
            context['faq_algemeen'] = DynamicPageContent_FR.objects.filter(identifier__icontains="algemeen")
        elif get_language() == 'en':
            context['faq_begrippen'] = DynamicPageContent_EN.objects.filter(identifier__icontains="begrippen")
            context['faq_algemeen'] = DynamicPageContent_EN.objects.filter(identifier__icontains="algemeen")
        else:
            context['faq_begrippen'] = DynamicPageContent.objects.filter(identifier__icontains="begrippen")
            context['faq_algemeen'] = DynamicPageContent.objects.filter(identifier__icontains="algemeen")
        print(context['faq_begrippen'])
        return render(request, self.template_name, context)
